class Conversation < ApplicationRecord
    ...
    def authenticate_to_faceme(params)
        response = HTTParty.post('https://dal-admin.faceme.com/api/v1/clients/access/tokens', {
            headers: {"Content-Type": "application/jwt", "workspace": Rails.application.credentials.workspace_id},
    ...
    def encode_payload(params)
        payload = {
            ...
            'fm-workspace' => Rails.application.credentials.fm_workspace.to_s,
        }

        hmac_secret = Rails.application.credentials.customer_jwt_secret
